...
A line equation was used to describe the *deterministic* relationship between degreen Celcius and degrees Fahrenheit.
...
```{r,fig.width=5,fig.height=5}
xyplot(Height~RtSpan,data=pennstate1,xlab="Right Handspan (cm)", ylab="Height (in)", main="Relationship Between Right Handspan and Height", type=c("r","p")) 
```
